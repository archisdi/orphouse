            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <h1>
                            <i class="fa fa-home"></i> Edit Orphanage                            
                        </h1>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-angle-right"></i> Level</a></li>
                            <li class="active">Edit</li>
                            <li class="active">Edit Orphanage</li>
                        </ol>
                    </section>
                    ...
                    <section class="content">
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                <form role="form" method="post" action="handler/edit_orph_handler.php">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <label>Orphanage Name</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-font"></i></span>
                                            <input type="text" class="form-control" placeholder="" name="nama" required="" value="<?php echo $fetch_panti["nama"] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="alamat" required="" value="<?php echo $fetch_panti["alamat"] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" data-inputmask='"mask": "(999) 9999-99999"' data-mask name="kontak" value="<?php echo $fetch_panti["kontak"] ?>">
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="maps" required="" value="<?php echo $fetch_panti["maps"] ?>">
                                        </div>
                                    </div>

                                    <!-- File Input -->
                                    <!--                                    <div class="form-group">
                                                                            <label for="exampleInputFile">Orphanage Picture</label>
                                ...
                                <br>              
                                <a href="edit_orph.php"><button type="button" class="btn btn-default">Cancel</button></a>
                            </div>
                            <!-- /.box-body -->
                        </div>
                    </section><!-- /.content -->
