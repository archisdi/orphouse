                                    ...
                                    <table id="example2" class="table table-hover" id="dataTables-example" align="center">
                                        ...
                                        <tbody>
                                            ...
                                            while ($fetch_panti = $call_panti->fetch_assoc()) {
                                                ?>
                                                <tr class="gradeA" >
                                                    <td><?php echo $fetch_panti["id_panti"] ?></td>
                                                    <td><?php echo $fetch_panti["nama"] ?></td>
                                                    <?php if ($fetch_panti["jumlah_anak"] == 0) { ?>
                                                        <td><button class="btn btn-info btn-flat" disabled=""><i><?php echo $fetch_panti["jumlah_anak"] ?></i></button></td>
                                                    <?php } else { ?>
                                                        <td><a href="view_child.php?id=<?php echo $fetch_panti["id_panti"] ?>"><button class="btn btn-info btn-flat"><i><?php echo $fetch_panti["jumlah_anak"] ?></i></button></a></td>
                                                    <?php } ?>                                                    
                                                    <td><a href="view_orph_detail.php?id=<?php echo $fetch_panti["id_panti"] ?>"><button class="btn btn-info btn-flat"><i class="glyphicon glyphicon-eye-open"></i></button></a></td>
