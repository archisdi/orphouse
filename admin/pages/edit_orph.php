                ...
                <section class="content">
                                        ...
                                        <tbody>
                                            ...
                                            while ($fetch_panti = $call_panti->fetch_assoc()) {
                                                ...
                                                <tr class="gradeA" >
                                                    ...
                                                    <td><a href="edit_orph_form.php?id=<?php echo $fetch_panti["id_panti"] ?>"><button class="btn btn-warning btn-flat"><i class="glyphicon glyphicon-edit"></i></button></a></td>
                                                </tr>
                                                <?php
                                            }
                                        } else {
                    ...
                    if (isset($_GET["stat"])) {
                        ...
                        <div class="alert alert-success alert-dismissable">
                            ...
                            Orhpanage Data successfully edited
                        </div>
                        <?php
                    }
                    ?>
