                    ...
                    <section class="content">
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                            ...
                                            <tbody>
                                                ...
                                                while ($fetch_anak = $call_anak->fetch_assoc()) {
                                                    ...
                                                    <tr class="gradeA" >
                                                        ...
                                                        <td><a href="edit_child_form.php?id=<?php echo $fetch_anak["id_anak"] ?>"><button class="btn btn-warning btn-flat"><i class="glyphicon glyphicon-edit"></i></button></a></td>
                                                    </tr>
                                                <?php }
                                                ?>
                                            </tbody>
                                ...
                                ?>                                
                                <br>              
                                <a href="edit_child.php"><button type="button" class="btn btn-default">Back</button></a>
                                </tbody>
